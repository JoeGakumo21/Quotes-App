...
export class QuotesComponent implements OnInit {
  ...
  myQuote:Quotes[]=[
    new Quotes("Joseph Gakumo ","Motivation Quote","Success is not Final, Failure is not Fatal, Its the courage to continue that counts","JoeKumsy Kenyan",'20th/Aug/2021'),
